...
void LCD_E_TOG(void)
{
    ...
    LATCbits.LATC2=1;
 _delay((unsigned long)((8)*(64000000/4000000.0)));
...
void LCD_setlines(char cname,char ch,signed char cmin,signed char cs,signed char cd,char cm, unsigned int cy,char cBST){
   char line1[20];
   char line2[20];
    sprintf(line1,"%d   %d: %d: %d" ,cname,ch,cmin,cs);
    sprintf(line2,"%d %d %d %d",cd,cm,cy,cBST);
